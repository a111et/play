...
#### Чтобы после установки модулей получить сертификацию надо сбросить пару приложение 
Чтобы Google Play "поверил" в полную целостность, нужно остановить, очистить кэш и данные у следующих приложений:

Google Play Store (Маркет).
Google Wallet (Кошелек).
Google Play Services (Сервисы Google).

после этого у нас должна в настройках Google play писаться "устройство сертифицированно"
